...
The Stitch export contains temporary imagery and several unverified details. Confirm these items with Rachel before publishing:
...
- Final photographic social sharing image, if preferred over the branded graphic
- Public domain name so canonical URLs, absolute social image URLs, and a sitemap can be added

The deployable preview starts at `site/index.html`.
